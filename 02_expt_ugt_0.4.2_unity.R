...
model.path = "/home/lee/NetLogo_models/ugt_0.4.2_unity.nlogo"

expt.name = "expt_ugt_0.4.2_unity_test_03"
...
#
msr = getherVariable(rest,"mid_saving_rate_2") %>%
  filterByTicks(400:500) %>%
  colMeans()

init_sr = getherParam(rest,"init_sr")

qplot(init_sr, msr) + geom_line()



plot(getherVariable(rest,"mid_saving_rate_2")[,9] ,type="l")
plot(getherVariable(rest,"mean_unity_2")[,9] ,type="l")
plot(getherVariable(rest,"sd_unity_2")[,9] ,type="l")
